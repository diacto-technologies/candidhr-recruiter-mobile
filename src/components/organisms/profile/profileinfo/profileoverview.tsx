  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.iconBox}>
       <SvgXml xml={phoneIcon} height={20} width={20}/>
        ...
        <View style={styles.textBox}>
          <Typography variant="semiBoldTxtsm" color={colors.gray[800]}>+91 8349 9085 14</Typography>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.textBox}>
          <Typography variant="semiBoldTxtsm" color={colors.gray[800]}>Sachin.patidar@diacto.com</Typography>
          <Typography variant="regularTxtsm" color={colors.gray[600]}>
            Email address
          </Typography>
        </View>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.textBox}>
          <Typography variant="semiBoldTxtsm" color={colors.gray[800]}>₹ 12,00,000</Typography>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.textBox}>
          <Typography variant="semiBoldTxtsm" color={colors.gray[800]}>3 Month</Typography>
          <Typography variant="regularTxtsm" color={colors.gray[600]}>
            Notice period
          </Typography>
        </View>
