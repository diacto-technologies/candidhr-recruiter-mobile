...
const ASSESSMENT_TABS = ['Assessments V1'] as const
type AssessmentTab = (typeof ASSESSMENT_TABS)[number]
const TAB_KEYS = {
  ASSIGNED: 'Assessments V1',
} as const
...
const OldAssessmentList: React.FC = () => {
  const styles = useStyles()
  const insets = useRNSafeAreaInsets()
  const dispatch = useAppDispatch()

  const [activeTab, setActiveTab] = useState<AssessmentTab>(TAB_KEYS.ASSIGNED)
...
export default OldAssessmentList