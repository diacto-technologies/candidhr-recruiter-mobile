  ...
  return (
    <NavigationContainer ref={navigationRef}>
        <Stack.Navigator initialRouteName='SplashScreen' screenOptions={{headerShown:false}}>
            ...
            <Stack.Screen  name='ForgetPasswordScreen' component={ForgetPasswordScreen} options={{animation:'fade'}}/>
            ...
            {/* <Stack.Screen name="ApplicationStageOverviewDetails" component={ApplicationStageOverviewDetails}/> */}
        </Stack.Navigator>
    </NavigationContainer>
  )
}
